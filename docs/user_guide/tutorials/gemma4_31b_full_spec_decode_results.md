...
speed-multilingual = 47 on GPU). The Google Assistant k=5 configuration was
also evaluated on 16× SN40 RDU chips for an acceptance-only comparison.
Skipped (no JSONL on this box): `aa-lcr`, `speed-low-entropy`. The same drafts
were also run as an AgentX concurrency sweep (Claude-Code trace replay at
1 / 8 / 16 / 32 / 64 / 128 users).
...
| DSpark Qwen (Mengmeng) | `/nvmedata/hf_checkpoints/gemma4_31b_dspark_nemo782k_scratch` | 8 | 0.28.0+cu129 | `gemma4-31b-full-dspark-nemo782k.yaml` |
| Google Assistant (MTP), RDU | `/import/ml-sc-nlpcheckpoints-scratch3/weip/gemma-4-31b-it-assistant-pad5632-prefix-split` | 5 | CoE / SN40-16 | `rdu_mtp_eval` |

DSpark Qwen (Mengmeng) was trained with `block_size=8` and `sample_from_anchor=True`.
...
- **QPS** — completed requests / wall time (`n / sum(e2e_s)`). Sequential eval
  (concurrency 1), so this is 1 / mean request latency, not a loaded-server QPS.

> DSpark Qwen (Mengmeng) tok/s and speedup mix vLLM 0.28 with a 0.24 baseline.
...
| benchmark | n | baseline | Google Assistant (MTP) k=5 | Eagle-3 Qwen k=5 | Eagle-3 Llama k=5 | DSpark Qwen k=8 | × Google Assistant (MTP) | × Eagle-3 Qwen | × Eagle-3 Llama | × DSpark Qwen |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
| benchmark | Google Assistant (MTP) k=5 AL | Eagle-3 Qwen k=5 AL | Eagle-3 Llama k=5 AL | DSpark Qwen k=8 AL | Google Assistant (MTP) k=5 AR | Eagle-3 Qwen k=5 AR | Eagle-3 Llama k=5 AR | DSpark Qwen k=8 AR |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
| benchmark | base e2e | Google Assistant (MTP) e2e | Eagle-3 Qwen e2e | Eagle-3 Llama e2e | DSpark Qwen e2e | base TTFT | Google Assistant (MTP) TTFT | Eagle-3 Qwen TTFT | Eagle-3 Llama TTFT | DSpark Qwen TTFT |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
| benchmark | n | baseline | Google Assistant (MTP) | Eagle-3 Qwen (Ravi) | Eagle-3 Llama (John) | DSpark Qwen (Mengmeng) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
...
`wall time` is sum of per-request `e2e_s`; `QPS` is `n / wall time` (sequential, concurrency 1).

| benchmark | config | n | wall time | QPS | decode tok/s | e2e tok/s | ttft (s) | comp. tokens | accept_len | accept_rate | speedup |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| aime | baseline (no draft) | 30 | 13.0m | 0.038 | 54.3 | 54.2 | 0.078 | 42422 | — | — | 1.00× |
|  | Google Assistant (MTP) | 30 | 3.8m | 0.132 | 168.8 | 166.8 | 0.096 | 37851 | 4.848 | 0.7696 | **3.11×** |
|  | Eagle-3 Qwen (Ravi) | 30 | 5.9m | 0.085 | 121.9 | 119.9 | 0.196 | 42190 | 3.620 | 0.5241 | **2.24×** |
|  | Eagle-3 Llama (John) | 30 | 5.1m | 0.098 | 138.2 | 136.9 | 0.096 | 41859 | 3.759 | 0.5518 | **2.55×** |
|  | DSpark Qwen (Mengmeng) | 30 | 3.6m | 0.138 | 211.6 | 208.9 | 0.096 | 45502 | 5.952 | 0.6190 | **3.90×** |
| gpqa | baseline (no draft) | 50 | 11.7m | 0.071 | 54.6 | 54.2 | 0.104 | 38159 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 4.6m | 0.182 | 155.4 | 152.0 | 0.129 | 41798 | 4.479 | 0.6958 | **2.85×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 7.3m | 0.114 | 98.5 | 97.1 | 0.133 | 42692 | 2.910 | 0.3819 | **1.80×** |
|  | Eagle-3 Llama (John) | 50 | 6.0m | 0.139 | 109.6 | 107.8 | 0.129 | 38871 | 2.942 | 0.3884 | **2.01×** |
|  | DSpark Qwen (Mengmeng) | 50 | 4.5m | 0.185 | 157.9 | 154.6 | 0.119 | 41824 | 4.350 | 0.4188 | **2.89×** |
| livecodebench | baseline (no draft) | 50 | 11.5m | 0.073 | 54.2 | 53.7 | 0.144 | 36918 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 4.3m | 0.192 | 152.0 | 147.3 | 0.167 | 38301 | 4.539 | 0.7077 | **2.80×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 6.1m | 0.137 | 102.4 | 100.1 | 0.173 | 36654 | 3.074 | 0.4148 | **1.89×** |
|  | Eagle-3 Llama (John) | 50 | 5.8m | 0.143 | 119.5 | 116.8 | 0.167 | 40730 | 3.365 | 0.4730 | **2.20×** |
|  | DSpark Qwen (Mengmeng) | 50 | 3.3m | 0.251 | 184.5 | 177.5 | 0.156 | 35346 | 5.198 | 0.5247 | **3.40×** |
| gsm8k | baseline (no draft) | 50 | 4.6m | 0.181 | 55.3 | 54.8 | 0.064 | 15166 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 1.3m | 0.633 | 199.2 | 190.2 | 0.077 | 15030 | 5.068 | 0.8135 | **3.60×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 1.8m | 0.459 | 143.6 | 138.7 | 0.081 | 15101 | 3.745 | 0.5490 | **2.60×** |
|  | Eagle-3 Llama (John) | 50 | 1.5m | 0.548 | 172.0 | 165.4 | 0.076 | 15079 | 4.074 | 0.6148 | **3.11×** |
|  | DSpark Qwen (Mengmeng) | 50 | 1.0m | 0.815 | 261.1 | 246.4 | 0.073 | 15126 | 6.426 | 0.6783 | **4.72×** |
| humaneval | baseline (no draft) | 50 | 4.3m | 0.196 | 55.1 | 54.5 | 0.079 | 13913 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 1.2m | 0.682 | 197.1 | 185.3 | 0.093 | 13577 | 5.183 | 0.8366 | **3.58×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 1.9m | 0.439 | 130.1 | 124.9 | 0.099 | 14225 | 3.508 | 0.5015 | **2.36×** |
|  | Eagle-3 Llama (John) | 50 | 1.5m | 0.568 | 163.9 | 155.8 | 0.093 | 13709 | 4.001 | 0.6002 | **2.97×** |
|  | DSpark Qwen (Mengmeng) | 50 | 1.0m | 0.814 | 242.3 | 226.2 | 0.086 | 13894 | 6.137 | 0.6421 | **4.40×** |
| mbpp | baseline (no draft) | 50 | 10.2m | 0.082 | 55.1 | 54.9 | 0.052 | 33490 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 3.3m | 0.254 | 171.7 | 169.1 | 0.066 | 33221 | 4.524 | 0.7049 | **3.12×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 4.9m | 0.170 | 114.7 | 113.5 | 0.071 | 33336 | 3.089 | 0.4178 | **2.08×** |
|  | Eagle-3 Llama (John) | 50 | 3.9m | 0.214 | 143.6 | 141.8 | 0.066 | 33114 | 3.529 | 0.5058 | **2.61×** |
|  | DSpark Qwen (Mengmeng) | 50 | 2.7m | 0.308 | 206.3 | 202.7 | 0.063 | 32942 | 5.239 | 0.5299 | **3.74×** |
| math500 | baseline (no draft) | 50 | 10.1m | 0.083 | 54.9 | 54.7 | 0.070 | 33011 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 3.0m | 0.275 | 185.4 | 181.4 | 0.085 | 32922 | 5.037 | 0.8075 | **3.38×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 4.0m | 0.206 | 137.8 | 135.5 | 0.090 | 32852 | 3.818 | 0.5635 | **2.51×** |
|  | Eagle-3 Llama (John) | 50 | 3.6m | 0.234 | 160.4 | 157.4 | 0.085 | 33580 | 4.084 | 0.6168 | **2.92×** |
|  | DSpark Qwen (Mengmeng) | 50 | 2.2m | 0.371 | 252.4 | 245.5 | 0.078 | 33047 | 6.590 | 0.6988 | **4.60×** |
| mt-bench | baseline (no draft) | 50 | 7.4m | 0.113 | 55.1 | 54.8 | 0.060 | 24239 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 3.2m | 0.260 | 128.5 | 126.3 | 0.073 | 24276 | 3.412 | 0.4823 | **2.33×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 5.0m | 0.167 | 82.7 | 81.7 | 0.078 | 24410 | 2.241 | 0.2482 | **1.50×** |
|  | Eagle-3 Llama (John) | 50 | 3.9m | 0.212 | 105.7 | 104.3 | 0.073 | 24608 | 2.619 | 0.3238 | **1.92×** |
|  | DSpark Qwen (Mengmeng) | 50 | 3.1m | 0.268 | 133.8 | 131.6 | 0.069 | 24556 | 3.423 | 0.3028 | **2.43×** |
| aime26 | baseline (no draft) | 30 | 16.1m | 0.031 | 54.0 | 53.9 | 0.078 | 52100 | — | — | 1.00× |
|  | Google Assistant (MTP) | 30 | 5.8m | 0.086 | 158.7 | 157.5 | 0.095 | 55142 | 4.769 | 0.7538 | **2.94×** |
|  | Eagle-3 Qwen (Ravi) | 30 | 7.7m | 0.065 | 118.7 | 118.0 | 0.097 | 54233 | 3.613 | 0.5225 | **2.20×** |
|  | Eagle-3 Llama (John) | 30 | 6.4m | 0.078 | 132.5 | 131.6 | 0.094 | 50612 | 3.699 | 0.5399 | **2.45×** |
|  | DSpark Qwen (Mengmeng) | 30 | 4.3m | 0.117 | 213.8 | 211.8 | 0.087 | 54529 | 6.102 | 0.6377 | **3.96×** |
| bfcl | baseline (no draft) | 50 | 42s | 1.180 | 55.2 | 49.2 | 0.109 | 2086 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 17s | 2.905 | 200.5 | 121.2 | 0.141 | 2086 | 5.587 | 0.9174 | **3.63×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 26s | 1.922 | 109.4 | 80.2 | 0.148 | 2086 | 3.134 | 0.4268 | **1.98×** |
|  | Eagle-3 Llama (John) | 50 | 22s | 2.228 | 133.3 | 93.0 | 0.143 | 2086 | 3.343 | 0.4686 | **2.41×** |
|  | DSpark Qwen (Mengmeng) | 50 | 17s | 2.914 | 198.9 | 121.6 | 0.138 | 2086 | 5.141 | 0.5177 | **3.60×** |
| swe-bench-pro | baseline (no draft) | 50 | 10.5m | 0.080 | 54.1 | 53.3 | 0.213 | 33430 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 4.0m | 0.210 | 147.0 | 140.0 | 0.234 | 33295 | 4.466 | 0.6932 | **2.72×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 7.1m | 0.118 | 79.1 | 76.9 | 0.244 | 32540 | 2.433 | 0.2866 | **1.46×** |
|  | Eagle-3 Llama (John) | 50 | 6.0m | 0.139 | 97.0 | 94.0 | 0.238 | 33833 | 2.755 | 0.3509 | **1.79×** |
|  | DSpark Qwen (Mengmeng) | 50 | 4.2m | 0.196 | 137.4 | 131.6 | 0.222 | 33502 | 3.958 | 0.3697 | **2.54×** |
| speed-coding | baseline (no draft) | 50 | 7.0m | 0.120 | 55.0 | 54.6 | 0.085 | 22795 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 2.3m | 0.356 | 174.7 | 168.8 | 0.100 | 23699 | 4.733 | 0.7466 | **3.18×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 3.5m | 0.235 | 110.2 | 107.7 | 0.105 | 22922 | 3.031 | 0.4062 | **2.00×** |
|  | Eagle-3 Llama (John) | 50 | 2.9m | 0.290 | 137.3 | 133.6 | 0.100 | 23043 | 3.452 | 0.4905 | **2.50×** |
|  | DSpark Qwen (Mengmeng) | 50 | 2.0m | 0.422 | 201.9 | 194.4 | 0.093 | 23064 | 5.241 | 0.5301 | **3.67×** |
| speed-multilingual | baseline (no draft) | 47 | 5.7m | 0.136 | 55.2 | 54.8 | 0.068 | 18886 | — | — | 1.00× |
|  | Google Assistant (MTP) | 47 | 1.9m | 0.417 | 169.9 | 164.5 | 0.082 | 18523 | 4.429 | 0.6859 | **3.08×** |
|  | Eagle-3 Qwen (Ravi) | 47 | 4.4m | 0.179 | 73.3 | 72.3 | 0.087 | 19011 | 1.957 | 0.1914 | **1.33×** |
|  | Eagle-3 Llama (John) | 47 | 3.9m | 0.199 | 80.5 | 79.3 | 0.082 | 18714 | 1.951 | 0.1901 | **1.46×** |
|  | DSpark Qwen (Mengmeng) | 47 | 3.6m | 0.220 | 90.7 | 89.4 | 0.076 | 19052 | 2.278 | 0.1597 | **1.64×** |
| speed-rag | baseline (no draft) | 50 | 1.1m | 0.745 | 54.8 | 48.0 | 0.184 | 3222 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 32s | 1.552 | 150.6 | 104.6 | 0.204 | 3370 | 4.387 | 0.6773 | **2.75×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 47s | 1.061 | 89.7 | 70.5 | 0.213 | 3325 | 2.614 | 0.3227 | **1.64×** |
|  | Eagle-3 Llama (John) | 50 | 40s | 1.238 | 105.7 | 79.9 | 0.207 | 3229 | 2.811 | 0.3622 | **1.93×** |
|  | DSpark Qwen (Mengmeng) | 50 | 33s | 1.516 | 138.7 | 99.6 | 0.193 | 3286 | 3.776 | 0.3470 | **2.53×** |
| speed-qa | baseline (no draft) | 50 | 3.4m | 0.243 | 55.4 | 54.9 | 0.051 | 11308 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 1.5m | 0.541 | 124.8 | 121.2 | 0.063 | 11197 | 3.157 | 0.4314 | **2.25×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 2.5m | 0.336 | 77.1 | 75.7 | 0.067 | 11259 | 1.991 | 0.1982 | **1.39×** |
|  | Eagle-3 Llama (John) | 50 | 2.0m | 0.412 | 96.5 | 94.4 | 0.062 | 11467 | 2.272 | 0.2543 | **1.74×** |
|  | DSpark Qwen (Mengmeng) | 50 | 1.7m | 0.491 | 114.5 | 111.6 | 0.059 | 11361 | 2.803 | 0.2253 | **2.07×** |
| speed-writing | baseline (no draft) | 50 | 20.8m | 0.040 | 53.9 | 53.6 | 0.176 | 66840 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 10.8m | 0.077 | 103.1 | 101.6 | 0.196 | 65919 | 3.118 | 0.4235 | **1.91×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 17.1m | 0.049 | 65.8 | 65.2 | 0.204 | 66827 | 2.013 | 0.2025 | **1.22×** |
|  | Eagle-3 Llama (John) | 50 | 13.6m | 0.061 | 82.4 | 81.4 | 0.199 | 66435 | 2.329 | 0.2658 | **1.53×** |
|  | DSpark Qwen (Mengmeng) | 50 | 11.2m | 0.074 | 101.5 | 100.2 | 0.186 | 67444 | 2.920 | 0.2400 | **1.88×** |
| HumanEval | baseline (no draft) | 50 | 4.7m | 0.177 | 55.2 | 54.7 | 0.070 | 15439 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 1.5m | 0.568 | 186.6 | 178.0 | 0.086 | 15665 | 4.902 | 0.7804 | **3.38×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 2.2m | 0.383 | 123.7 | 119.8 | 0.091 | 15659 | 3.312 | 0.4624 | **2.24×** |
|  | Eagle-3 Llama (John) | 50 | 1.7m | 0.478 | 155.0 | 149.1 | 0.086 | 15586 | 3.784 | 0.5567 | **2.81×** |
|  | DSpark Qwen (Mengmeng) | 50 | 1.2m | 0.711 | 233.4 | 220.9 | 0.080 | 15523 | 5.901 | 0.6127 | **4.23×** |
| math_reasoning | baseline (no draft) | 50 | 2.6m | 0.322 | 55.4 | 54.7 | 0.059 | 8507 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 46s | 1.096 | 201.7 | 187.2 | 0.071 | 8535 | 5.066 | 0.8131 | **3.64×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 1.0m | 0.797 | 143.2 | 135.4 | 0.075 | 8494 | 3.675 | 0.5350 | **2.58×** |
|  | Eagle-3 Llama (John) | 50 | 52s | 0.965 | 175.1 | 164.1 | 0.071 | 8506 | 4.071 | 0.6143 | **3.16×** |
|  | DSpark Qwen (Mengmeng) | 50 | 35s | 1.414 | 262.6 | 239.8 | 0.065 | 8477 | 6.360 | 0.6700 | **4.74×** |
| qa | baseline (no draft) | 50 | 3.4m | 0.243 | 55.4 | 54.9 | 0.051 | 11308 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 1.5m | 0.541 | 124.8 | 121.1 | 0.062 | 11197 | 3.157 | 0.4314 | **2.25×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 2.5m | 0.336 | 77.1 | 75.7 | 0.067 | 11259 | 1.991 | 0.1982 | **1.39×** |
|  | Eagle-3 Llama (John) | 50 | 2.0m | 0.412 | 96.5 | 94.4 | 0.062 | 11467 | 2.272 | 0.2543 | **1.74×** |
|  | DSpark Qwen (Mengmeng) | 50 | 1.7m | 0.491 | 114.5 | 111.6 | 0.059 | 11361 | 2.803 | 0.2253 | **2.07×** |
| question | baseline (no draft) | 50 | 7.4m | 0.113 | 55.1 | 54.8 | 0.058 | 24329 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 3.2m | 0.260 | 128.3 | 126.2 | 0.072 | 24281 | 3.408 | 0.4816 | **2.33×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 5.0m | 0.168 | 82.9 | 82.0 | 0.077 | 24420 | 2.240 | 0.2480 | **1.50×** |
|  | Eagle-3 Llama (John) | 50 | 3.9m | 0.212 | 105.6 | 104.2 | 0.072 | 24556 | 2.617 | 0.3234 | **1.92×** |
|  | DSpark Qwen (Mengmeng) | 50 | 3.1m | 0.268 | 133.6 | 131.4 | 0.069 | 24521 | 3.416 | 0.3020 | **2.42×** |
| rag | baseline (no draft) | 50 | 1.0m | 0.809 | 54.7 | 49.9 | 0.126 | 3085 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 30s | 1.691 | 141.1 | 106.8 | 0.151 | 3158 | 4.154 | 0.6308 | **2.58×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 45s | 1.100 | 83.7 | 69.1 | 0.170 | 3143 | 2.462 | 0.2924 | **1.53×** |
|  | Eagle-3 Llama (John) | 50 | 38s | 1.301 | 100.7 | 81.1 | 0.159 | 3116 | 2.704 | 0.3407 | **1.84×** |
|  | DSpark Qwen (Mengmeng) | 50 | 32s | 1.584 | 129.2 | 99.0 | 0.155 | 3125 | 3.543 | 0.3178 | **2.36×** |
| summarization | baseline (no draft) | 50 | 2.3m | 0.368 | 54.5 | 50.9 | 0.199 | 6923 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 1.2m | 0.692 | 111.2 | 95.1 | 0.219 | 6875 | 3.290 | 0.4579 | **2.04×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 2.0m | 0.421 | 63.2 | 57.6 | 0.228 | 6835 | 1.881 | 0.1762 | **1.16×** |
|  | Eagle-3 Llama (John) | 50 | 1.7m | 0.503 | 78.0 | 69.8 | 0.222 | 6941 | 2.128 | 0.2256 | **1.43×** |
|  | DSpark Qwen (Mengmeng) | 50 | 1.4m | 0.616 | 96.8 | 85.1 | 0.207 | 6902 | 2.697 | 0.2121 | **1.78×** |
| tool_call | baseline (no draft) | 50 | 1.7m | 0.502 | 55.2 | 51.0 | 0.170 | 5075 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 43s | 1.163 | 148.5 | 116.5 | 0.192 | 5012 | 4.012 | 0.6024 | **2.69×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 1.2m | 0.701 | 82.2 | 71.4 | 0.200 | 5089 | 2.281 | 0.2562 | **1.49×** |
|  | Eagle-3 Llama (John) | 50 | 55s | 0.909 | 108.3 | 90.2 | 0.193 | 4958 | 2.722 | 0.3444 | **1.96×** |
|  | DSpark Qwen (Mengmeng) | 50 | 45s | 1.111 | 135.7 | 109.4 | 0.182 | 4921 | 3.492 | 0.3115 | **2.46×** |
| translation | baseline (no draft) | 50 | 3.2m | 0.259 | 55.4 | 54.9 | 0.054 | 10607 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 1.1m | 0.732 | 160.7 | 153.7 | 0.066 | 10492 | 4.023 | 0.6045 | **2.90×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 2.1m | 0.401 | 87.7 | 85.6 | 0.071 | 10667 | 2.243 | 0.2487 | **1.58×** |
|  | Eagle-3 Llama (John) | 50 | 1.7m | 0.504 | 111.4 | 108.2 | 0.066 | 10735 | 2.590 | 0.3181 | **2.01×** |
|  | DSpark Qwen (Mengmeng) | 50 | 1.3m | 0.650 | 142.7 | 137.7 | 0.062 | 10582 | 3.463 | 0.3079 | **2.58×** |
| writing | baseline (no draft) | 50 | 7.5m | 0.111 | 55.1 | 54.9 | 0.048 | 24711 | — | — | 1.00× |
|  | Google Assistant (MTP) | 50 | 3.2m | 0.260 | 128.4 | 126.3 | 0.070 | 24280 | 3.408 | 0.4817 | **2.33×** |
|  | Eagle-3 Qwen (Ravi) | 50 | 5.0m | 0.167 | 82.5 | 81.7 | 0.074 | 24455 | 2.237 | 0.2474 | **1.50×** |
|  | Eagle-3 Llama (John) | 50 | 4.0m | 0.211 | 105.5 | 104.2 | 0.069 | 24705 | 2.616 | 0.3231 | **1.91×** |
|  | DSpark Qwen (Mengmeng) | 50 | 3.1m | 0.268 | 133.4 | 131.3 | 0.067 | 24497 | 3.412 | 0.3016 | **2.42×** |

## Observations

DSpark Qwen (Mengmeng) wins math/code (gsm8k AL 6.43, math500 6.59) and beats
...
| Google Assistant (MTP), RDU | `scripts/evaluate/experiments/results/gemma4-31b-rdu-k5/` |
...
# DSpark Qwen (Mengmeng) (vLLM 0.28.0+cu129; skip baseline)
