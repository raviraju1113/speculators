#!/bin/bash
# sngpu payload: DSpark Gemma-4 FULL RUN, lr 1e-4 (upstream schema default; Ravi found 1e-4 >> 1e-5 for EAGLE-3).
...
#
#   sngpu --jobname dspark_lr1e4 --partition gpuonly \
#     --exclude sc-c96,sc3-c97,sc-c82 \
#     --gpu 2 --gputype a100m80 --cpu 24 --mem 200000 --time 48:00:00 \
#     --output ./logs/dspark_full_lr1e4.txt \
#     -- bash /import/ml-sc-scratch1/mengmengj/speculators/examples/train/run_full_lr1e4.sh
set -euo pipefail

export MODE=full
export LR=1e-4
export EPOCHS=2
export RUN_NAME=gemma4_31b_dspark_full_lr1e4
