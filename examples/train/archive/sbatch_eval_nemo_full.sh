...
python run_experiments.py --config gemma4-31b-dspark-nemo-full.yaml --only nemo_ep24_k8_full  # k3/k5 done (job 169); 099 excluded: /tmp full breaks JIT
