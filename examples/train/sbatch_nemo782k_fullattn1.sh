...
bash examples/train/run_nemo782k_fullattn1_local.sh

sleep 60
podman wait dspark_fullattn1 &
trap 'echo "scancel -> graceful stop"; podman stop -t 300 dspark_fullattn1' TERM INT
wait $!
