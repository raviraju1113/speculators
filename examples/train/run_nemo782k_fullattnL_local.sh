...
export FULL_ATTENTION_INDICES="${FULL_ATTENTION_INDICES:-4}"   # ablation: 4 sliding + 1 full LAST (layer 4)
export WANDB_RUN_ID="${WANDB_RUN_ID:-fullattnLnemo}"
...
export RUN_NAME=gemma4_31b_dspark_nemo782k_fullattnL
export JOBNAME="${JOBNAME:-dspark_fullattnL}"
