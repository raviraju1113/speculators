...
bash examples/train/run_nemo782k_fullattnL_local.sh

sleep 60
podman wait dspark_fullattnL &
trap 'echo "scancel -> graceful stop"; podman stop -t 300 dspark_fullattnL' TERM INT
wait $!
