...
# Optional pin, e.g. NODELIST=sc3-s240 ./submit_snrdu.sh
NODELIST="${NODELIST:-}"
# Drain/down 16-tile nodes make Slurm report ReqNodeNotAvail and skip idle boxes.
EXCLUDE="${EXCLUDE:-sc3-s164,sc3-s270}"
